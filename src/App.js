...
const App = () => {
    ...
    const authenticate = async () => {
      try {
        ...
        setMODAL({
          ...
          header: (
            <>
              <span className="text-danger">Authentication Error</span>
            </>
          ),
          body: (
            <>
              <span className="text-danger">
                There is some error in Authenticating you with server.
              </span>
            </>
          ),
          success: false,
  ...
  return (
    <>
        ...
        <UserContext.Provider value={{ USER, setUSER }}>
          ...
          >
            <Routes>
              ...
              />
              <Route exact path="/all-tasks" element={<Menu />} />
      ...
      <Loader show={LOADER} setLOADER={setLOADER} />
